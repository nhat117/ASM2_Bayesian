...
plot(myData$FamilySize, myData$MedianIncome, xlab = "Family size", ylab = "Median income",  xlim = c(0,9), ylim = c(1000, 110000))
...
source("Jags-Ymet-Xmet-Mrobust-Quadratic.R")
#------------------------------------------------------------------------------- 
...
summaryInfo = smryMCMC( mcmcCoda , 
                        ...
                        compValBeta2=0.0 , ropeBeta2=c(-0.5,0.5) ,
